...
module.exports = (sequelize) => {
  return sequelize.define(
    "Installment",
    {
      ...
      finePercentPerDay: { type: DataTypes.FLOAT, defaultValue: 1.5 },
      fineAmount: { type: DataTypes.FLOAT, defaultValue: 0 },
      fineDiscount: { type: DataTypes.FLOAT, defaultValue: 0 },
      finePaid: { type: DataTypes.FLOAT, defaultValue: 0 },
      lateDays: { type: DataTypes.INTEGER, defaultValue: 0 },
